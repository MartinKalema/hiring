...
interface Props {
  ...
  agentVolume: number;
  userVolume: number;
  agentState?: string; // listening, thinking, speaking, idle
}
...
const Hal: FC<Props> = ({ width = 0, height = 0, agentVolume = 0, userVolume = 0, agentState = 'idle' }: Props) => {
