...
export default function SoftwareDevelopmentJobsPage() {
  // Initial filter to only show Software Development jobs
  const initialJobs = jobsData.filter((job) => job.category === "Software Development")
  ...
  }, [searchQuery, selectedFilters, sortOption, initialJobs])
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <CategoryHeader
        ...
        jobCount={totalJobs}
        description="Technology is in everything we do. We rely on it to provide the excellence our customers deserve. And that's why our software engineers are crucial to every aspect of our operations."
        stacked={true}
      />
            ...
            <form onSubmit={handleSearch} className="flex gap-2 mb-6">
              <div className="relative flex-grow">
                ...
                <Input
                  ...
                  className="pl-10 bg-white border h-12 text-gray-800"
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                />
              </div>
              <Button type="submit" className="bg-aibos-blue hover:bg-aibos-darkBlue h-12 px-6">
                Search
              </Button>
            </form>
